...
// upload_file($encoded_string,$name,$id,$mentor_id,$goal);
// }else{

//   database_saving($file_dir,$name,$id,$mentor_id,$goal);
// }
    
    
upload_file($encoded_string,$name,$id,$mentor_id,$goal);

function upload_file($encoded_string,$name,$id,$mentor_id,$goal){
...
function database_saving($file_dir,$name,$id,$mentor_id,$goal){
...
// echo $largestNumber;
    ...
    $sql = "INSERT INTO mentee_goals (file_url,file_name,mentor_id,goals,mentee_id)VALUES ('$file_dir','$name','$mentor_id','$goal',$id)";
    $conn->query($sql);
