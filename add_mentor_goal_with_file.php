...
if (strlen($encoded_string)==1 && $name==null) {
   database_saving_1($id,$goal);
} else {
    upload_file($encoded_string,$name,$id,$goal);
    }
...
function upload_file($encoded_string,$name,$id,$goal){
    ...
    try {
        ...
        database_saving($file_dir,$name,$id,$goal);
...
function database_saving($file_dir,$name,$id,$goal){
...
// echo $largestNumber;
    ...
    $sql = "INSERT INTO mentor_goals (file_url,file_name,mentor_id,goals)VALUES ('$file_dir','$name','$id','$goal')";
    $conn->query($sql);


}

function database_saving_1($id,$goal){
    $servername = "localhost";
    $username = "root";
    $password = "";
    $dbname = "drsmith1";
...
// echo $largestNumber;
    ...
    $sql = "INSERT INTO mentor_goals (mentor_id,goals)VALUES ('$id','$goal')";
    $conn->query($sql);
