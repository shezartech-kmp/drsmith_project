...
header('Content-Type: application/x-www-form-urlencoded');
 ...
 //$encoded_string =$_POST['base64_file'] ;
 // echo "$encoded_string";
...
// echo "hlw";
upload_file($encoded_string,$name);

function upload_file($encoded_string,$name){
...
function database_saving($file_dir,$name){
...
// Check connection
    ...
    $sql = "INSERT INTO uploaded_files (file_url,file_name)VALUES ('$file_dir','$name')";
    $conn->query($sql);
    $conn->close();
